...
public class RouteController {
  ...
  public ResponseEntity<?> findCourseTime(
    ...
    try {
      ...
      if (doesCourseExists) {
        ...
        Course requestedCourse = coursesMapping.get(Integer.toString(courseCode));
        String courseTimeDetails = requestedCourse.getCourseTimeSlot();
        return new ResponseEntity<>("The course meets at: " + courseTimeDetails,
            HttpStatus.OK);
      } else {
        return new ResponseEntity<>("Course Not Found", HttpStatus.NOT_FOUND);
      }
   ...
   * This method handles PATCH requests to change the entrllment count of a course identified by
